...
module.exports = [
    ...
    [
        new Column(``, width.c1),
        new Column(`  ${styles.dim('>>')}  -d, --details`, width.c2),
        new Column(
            `Show Configuration Details ${styles.detail('optional')}`,
            width.c3
        ),
    ],
    [
    ...
    [
        new Column(``, width.c1),
        new Column(`--state`, width.c2),
        new Column(`Show Current BLDR State`, width.c3),
    ],
];
