 ...
 *
 */
const AutomationStudioSwitch = (req, argv) =>
...
const processAutomationCloneRequest = (cloneAutomationRequest) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        cloneAutomationRequest &&
            ...
            (yield (0, CreateLocalFiles_1.createAutomationStudioEditableFiles)(
                cloneAutomationRequest.formattedAutomationDefinitions
            ));
        yield (0, manifestJSON_1.updateManifest)('automationStudio', {
        ...
        (0,
        display_1.displayLine)(`>> Cloned ${cloneAutomationRequest.formattedAutomationDefinitions.length} Definitions`);
        // Create Automation Dependencies
        Object.keys(cloneAutomationRequest.formattedAutomationDependencies) &&
            Object.keys(cloneAutomationRequest.formattedAutomationDependencies).forEach((context) =>
                __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    (0,
                    display_1.displayLine)(`>> Cloned ${contextDependencies.assets.length} ${context} Dependencies`);
                })
            );
    });
