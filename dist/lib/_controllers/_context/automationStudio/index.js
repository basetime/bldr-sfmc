        ...
        switch (req) {
            ...
            case 'clone':
                ...
                if (typeof argv.f === 'string' && argv.f.includes(':')) {
                    ...
                    const formattedAssetResponse = (yield assets) && Array.isArray(assets) && assets.map((asset) => {
                    ...
                    const formattedAssetCategories = folders && Array.isArray(folders) && folders.map((category) => {
                        return {
                            id: category.ID,
                            name: category.Name,
                            parentId: category.ParentFolder.ID,
...
const processAutomationCloneRequest = (cloneAutomationRequest) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    Object.keys(cloneAutomationRequest.formattedAutomationDependencies) &&
        Object.keys(cloneAutomationRequest.formattedAutomationDependencies).forEach((context) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            switch (context) {
                case 'contentBuilder':
                    manifestUpdates.folders = contextDependencies && Array.isArray(contextDependencies) && contextDependencies.map((dep) => dep.category);
