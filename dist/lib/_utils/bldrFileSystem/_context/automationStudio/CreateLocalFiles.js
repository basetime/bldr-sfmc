 ...
 * @param assets
 */
const createAutomationStudioEditableFiles = (assets) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            for (const a in assets) {
                ...
                createFileResult &&
                    (0, display_1.displayLine)(
                        `Successfully Created [local | ${assetTypeName}]: ${asset.name || asset.Name}`,
                        'success'
                    );
                !createFileResult &&
                    (0, display_1.displayLine)(
                        `Error Creating File [local | ${assetTypeName}]: ${asset.name || asset.Name}`,
                        'error'
                    );
            }
        } catch (err) {
