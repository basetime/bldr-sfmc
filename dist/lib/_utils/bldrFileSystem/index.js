...
exports.normalizedPackageManifestJSONPath =
    exports.normalizedManifestJSONPath =
    exports.normalizedGitIgnorePath =
    exports.normalizedTemplateENVPath =
    exports.normalizedENVPath =
    exports.normalizedRoot =
    exports.resolvedRoot =
...
const createEnv = (config = null, template = true) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if ((0, fileSystem_1.fileExists)(path_1.default.join(rootPath, '.gitignore'))) {
            yield (0, fileSystem_1.appendFile)(
                path_1.default.join(rootPath, '.gitignore'),
                `\n#sfmc env \n.sfmc.env.json`
            );
        } else {
