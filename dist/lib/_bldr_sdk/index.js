 ...
 * @param accessToken
 */
const getAuthenticatedUserPermissions = (authObject) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            return (_a = userRequest === null || userRequest === void 0 ? void 0 : userRequest.data) === null ||
                _a === void 0
                ? void 0
                : _a.permissions;
        } catch (err) {
 ...
 * @returns
 */
const verifyChallengeCode = (authObject, code) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            if (!code) {
 ...
 * @returns
 */
const oAuthInitiator = (authObject) =>
    __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const initiateBldrSDK = (authObject, instance, configurationType, account_id) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (authObject && configurationType && configurationType === 'Server-to-Server') {
                ...
                if (verified) {
                    ...
                    yield (0, keytar_sync_1.setPassword)(
                        'bldr',
                        'currentSession',
                        JSON.stringify({
                            instance,
                    ...
                    debug(
                        'Check Session Saved',
                        'info',
                        yield (0, keytar_sync_1.getPassword)('bldr', 'currentSession')
                    );
            ...
            debug(
                ...
                'info',
                Object.assign(Object.assign({}, stateConfiguration), {
            ...
            if (
                ...
                if (currentSession && !sessionExpired && !midUpdated && stateInstance === currentSessionJSON.instance) {
                    debug(
                        ...
                        'info',
                        Object.assign(Object.assign({}, sdkConfiguration), currentAuthObject)
                    );
                ...
                if (currentSession && stateInstance === currentSessionJSON.instance && !sessionExpired && !midUpdated) {
                    ...
                    const verified = Object.assign(
                        {},
                        yield oAuthInitiator(Object.assign(Object.assign({}, sdkConfiguration), currentAuthObject))
                    );
                    debug('Initiate sdk Web-App: Received Verification', 'info', verified);
                    if (verified) {
