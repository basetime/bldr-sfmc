                        ...
                        .then((initResults) =>
                            __awaiter(this, void 0, void 0, function* () {
                                ...
                                try {
                                    ...
                                    const tagsArray =
                                        (tagsSplit === null || tagsSplit === void 0
                                            ? void 0
                                            : tagsSplit.map((tag) => tag.trim())) || [];
                                    ...
                                    for (const c in availableContexts) {
                                        ...
                                        contextAssets = yield (0, bldrFileSystem_1.replaceBldrSfmcEnv)(
                                        ...
                                        switch (context) {
                                            case 'contentBuilder':
                                                ...
                                                yield sdk.cli.contentBuilder.setContentBuilderPackageAssets(
                                                    packageOut,
                                                    contextAssets
                                                );
                                                const gatherDependencies =
                                                    yield sdk.cli.contentBuilder.setContentBuilderDependenciesFromPackage(
                                                        packageOut
                                                    );
                                                ...
                                                for (const k in newContextKeys) {
                                                    ...
                                                    yield (0,
                                                    CreateFilesBasedOnContext_1.createEditableFilesBasedOnContext)(
                                                        newContextKeys[k],
                                                        newAssets
                                                    );
                                                }
                                    ...
                                    (_a =
                                        packageOut === null || packageOut === void 0
                                            ? void 0
                                            : packageOut.contentBuilder) === null || _a === void 0
                                        ? void 0
                                        : _a.assets.forEach((asset) => {
                                              delete asset.id;
                                              delete asset.exists;
                                          });
                                    (_b =
                                        packageOut === null || packageOut === void 0
                                            ? void 0
                                            : packageOut.dataExtension) === null || _b === void 0
                                        ? void 0
                                        : _b.assets.forEach((asset) => {
                                              delete asset.category.categoryId;
                                          });
                                    let packageOutRendered = yield (0, bldrFileSystem_1.scrubBldrSfmcEnv)(
                                        JSON.stringify(packageOut)
                                    );
                                    packageOutRendered = JSON.parse(packageOutRendered);
                                    yield (0,
                                    fileSystem_2.createFile)('./package.manifest.json', JSON.stringify(packageOutRendered, null, 2));
