...
class Install {
    constructor() {
        this.installPackage = (argv) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
                    let pkgData;
                    let deployURL = argv && argv._ && argv._[1];
                    deployURL =
                        deployURL === null || deployURL === void 0
                            ? void 0
                            : deployURL.replace(/^\/\/|^.*?:(\/\/)?/, '');
                    ...
                    yield (0,
                    fileSystem_1.createFile)(`./package.manifest.json`, JSON.stringify(pkgData.package, null, 2));
                } catch (err) {
                    console.log(err.message);
                }
            });
        this.githubJSON = (deployURL) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
                    //process github
                    let readmeData;
                    ...
                    const getRepository = yield axios_1.default.get(
