...
class Deploy {
    constructor() {
                ...
                try {
                    ...
                    for (const c in packageContexts) {
                        ...
                        if (context && packageJSON[context]) {
                            ...
                            !sfmcOnly &&
                                (yield (0, CreateFilesBasedOnContext_1.createEditableFilesBasedOnContext)(
                                    context,
                                    pkgAssets
                                ));
         ...
         */
        this.deployContentBuilderAssets = (sdk, contentBuilderAssets) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
         ...
         */
        this.deployContentBuilderAssetNoDependencies = (sdk, contentBuilderAsset) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                contentBuilderAsset = yield (0, definitions_1.setContentBuilderDefinition)(
                    contentBuilderAsset,
                    buildContent
                );
                if (category) {
                ...
                const createAsset =
                    (!packageDeployIgnore_1.packageDeployIgnore.includes(contentBuilderAsset.assetType.name) &&
                        (yield sdk.sfmc.asset.postAsset(contentBuilderAsset))) ||
                    (0, display_1.displayLine)(
         ...
         * @param contentBuilderAssets
         */
        this.deployContentBuilderAssetWithDependencies = (sdk, contentBuilderAsset) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (packageDeployIgnore_1.packageDeployIgnore.includes(contentBuilderAsset.assetType.name)) {
                    ...
                    yield (0, CreateFilesBasedOnContext_1.createEditableFilesBasedOnContext)('contentBuilder', [
                        updatedAsset,
                    ]);
                } else if (createAsset.status === 'ERROR') {
         ...
         * @returns
         */
        this.updateContentBuilderReferences = (contentBuilderAsset, assetDependencies) =>
            __awaiter(this, void 0, void 0, function* () {
                let createdId;
                let content = contentBuilderAsset.content;
         ...
         * @returns
         */
        this.deployDataExtension = (sdk, dataExtensions) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
                    const output = [];
                    for (const d in dataExtensions) {
                        ...
                        const manifestJSONFolder = manifestJSON['dataExtension']['folders'].find(
                            (folder) => folder.folderPath === dataExtension.category.folderPath && folder
                        );
