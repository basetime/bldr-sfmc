...
class Config {
    constructor() {
         ...
         *
         */
        this.initiateConfiguration = (argv) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
                    (0,
                    display_1.displayLine)('For Web App Configurations, use the following as the Redirect URI in your Installed Package', 'info');
                    ...
                    (0, yargs_interactive_1.default)()
                        ...
                        .then((configResults) =>
                            __awaiter(this, void 0, void 0, function* () {
                                ...
                                const encryptedConfiguration = Object.assign(Object.assign({}, configured), {
                                    mids: instanceBusinessUnits,
                                    apiClientId: yield encrypt(configResults.apiClientId),
                                    apiClientSecret: yield encrypt(configResults.apiClientSecret),
                                });
                                ...
                                yield (0,
                                keytar_sync_1.setPassword)('bldr', configured.instance, JSON.stringify(encryptedConfiguration));
                                const credentialCheck = yield (0, keytar_sync_1.getPassword)(
                                    'bldr',
                                    configured.instance
                                );
         ...
         *
         */
        this.getInstanceConfiguration = (instance, show) =>
            __awaiter(this, void 0, void 0, function* () {
                if (!instance) {
         ...
         * @param {object} argv
         */
        this.listInstanceConfiguration = (argv) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                const instanceArr =
                    (yield (0, keytar_sync_1.findCredentials)('bldr'))
                        .map((item) => {
