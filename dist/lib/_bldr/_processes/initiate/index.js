...
class Initiate {
    constructor() {
        ...
        this.initiateContentBuilderProject = () =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                (0, yargs_interactive_1.default)()
                    ...
                    .then((initResults) =>
                        __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield (0,
                            fileSystem_1.createFile)(`${initFolderPath}/${initResults.dataExtensionName}.json`, dataExtensionInit);
