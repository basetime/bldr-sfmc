...
class Push {
    constructor() {
         ...
         * @returns
         */
        this.pushToSFMC = (stashFiles, manifestContextAssets, manifestContextFolders) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    for (let f = 0; f < stashFiles.length; f++) {
                        ...
                        if (method === 'put') {
                            sfmcUpdateObject = manifestContextAssets.find(
                                (manifestItem) => manifestItem.bldrId === bldrId
                            );
                            if (sfmcUpdateObject) {
                        ...
                        if (sfmcUpdateObject) {
                            ...
                            switch (stashFileContext) {
                                case 'automationStudio':
                                    if (method === 'put') {
                                        sfmcAPIObject =
                                            (stashFileObject === null || stashFileObject === void 0
                                                ? void 0
                                                : stashFileObject.fileContent) &&
                                            (yield (0, definitions_1.setAutomationStudioDefinition)(
                                                sfmcUpdateObject,
                                                stashFileObject.fileContent
                                            ));
                                ...
                                case 'sharedContent':
                                    ...
                                    sfmcAPIObject = yield (0, definitions_2.setContentBuilderDefinition)(
                                        sfmcUpdateObject,
                                        stashFileObject.fileContent
                                    );
                                ...
                                case 'dataExtension':
                                    ...
                                    if (
                                        ...
                                        yield (0, fileSystem_1.createFile)(
