 ...
 */
const addNewFolders = (stashItemFolderPath) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            for (const stashItemFolder in stashItemFolderArray) {
                ...
                manifestFolders = yield (0, _1.uniqueArrayByKey)(
                    [...manifestAssetCategories, ...manifestFolderCategories],
                    'folderPath'
                );
                // Check if folder path exists in .local.manifest.json
                const folderIndex = manifestFolders.findIndex(
                    (manifestFolder) => checkPath && manifestFolder.folderPath.includes(checkPath)
                );
                        ...
                        do {
                            ...
                            if (newFolderId) {
                                (0, display_1.displayLine)(
                                    `${folder} has been created; CategoryId: ${newFolderId}`,
                                    'success'
                                );
                                ...
                                yield (0, manifestJSON_1.updateManifest)(context.context, {
 ...
 * @returns
 */
const addExistingFolderToManifest = (sdk, request) =>
    __awaiter(void 0, void 0, void 0, function* () {
